...
@keyframes loader-inner {
  ...
  <main role="main" class="container">
      <div class="album py-3">
         ...
         <h4 style="color:#003a70;"> ผลการเลือกตั้งคณะกรรมการดำเนินการ <br>สหกรณ์ออมทรัพย์ มหาวิทยาลัยสวนดุสิต จำกัด ประจำปี 2567 </h4>
          </div>
          </div>
                        ...
                        <thead>
                          <tr>                            
                           <th style="vertical-align:middle;text-align:center;font-size: 12px;">หมายเลข</th>
                            ...
                            <th style="vertical-align:middle;text-align:center;font-size: 12px;">ลำดับคะแนน</th>                    
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <td style="font-size:12px;"><?php echo $r->candidate_name;?></td>
                          <td style="vertical-align:middle;text-align:center;"><?php echo $r->total;?></td>
                           <td style="vertical-align:middle;text-align:center;"><?php echo $r->row_num;?></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
                    ...
                    <div class="table-responsive " id="tbl_score">
                      <table class="table table-bordered" id="desktop" style="width:100%">
                        ...
                        <tbody>
                          ...
                          <td style="font-size:12px;"><?php echo $r2->candidate_name;?></td>
                    ...
                    <div class="table-responsive " id="tbl_score">
                      <table class="table table-bordered" id="desktop" style="width:100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                           <td style="vertical-align:middle;text-align:center;"><strong><?php echo $r3->c_number;?></strong></td>
                          <td style="font-size:12px;"><?php echo $r3->candidate_name;?></td>
                          <td style="vertical-align:middle;text-align:center;"><?php echo $r3->total;?></td>
                           <td style="vertical-align:middle;text-align:center;"><?php echo $r3->row_num;?></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
