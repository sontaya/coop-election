   ...
   <div class="row">
    <div class="col-12 text-center">
      <div class="section-title mb-4 pb-2">
        <h3 class="mb-1">ลงคะแนนเลือกตั้งคณะกรรมการดำเนินการสหกรณ์ออมทรัพย์</h3>
        <p class="para-desc mx-auto mb-0 mt-0">มหาวิทยาลัยสวนดุสิต จำกัด ประจำปี 2568</p>
        <h5 class="mb-1 mt-3 text-primary text-bold ">"เลือกผู้สมัครได้ไม่เกิน 7 คน โดยคลิกเลือกที่รูปผู้สมัคร"</h5>
      ...
      <div class="col-md-10">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">1.รายชื่อผู้สมัครคณะกรรมการดำเนินการ</h3>
          </div>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col col-lg-3 col-md-3 col-sm-3 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate2 imgbgchk" name="candidate_id2[]" value="<?php echo $r2->id; ?>" title='2' id="chk_<?php echo $r2->id;?>" />
                        ...
                        <label for="chk_<?php echo $r2->id; ?>">
                          <img src="<?php echo base_url();?>uploads/2568/<?php echo $r2->picture;?>" alt="Image<?php echo $r2->c_number; ?>" width="120px">
...
<div class="row add_bottom_15">
      <div class="col-md-10 ">
 					<button type="button" class="btn btn-block btn-success btn-lg" id="submit2"> บันทึกการลงคะแนน</button>
      </div>
    </div>
</form>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-md-12 ">
        <div>
          Copyright &copy; 2568 มหาวิทยาลัยสวนดุสิต
        </div>
      </div>
    </div>
  </div>
