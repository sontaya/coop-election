   ...
   <div class="row">
    <div class="col-12 text-center">
      <div class="section-title mb-4 pb-2">
        ...
        <p class="para-desc mx-auto mb-0 mt-0">มหาวิทยาลัยสวนดุสิต จำกัด ประจำปี 2565</p>
  ...
  <form action="" method="POST" id="frmvote">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="row">
             ...
             <?php foreach ($candidate1s as $key => $r){ ?>

              <div class="col col-lg-2 col-md-2 col-sm-2 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate1 imgbgchk" name="candidate_id1[]" value="<?php echo $r->c_group.$r->c_number; ?>" title='1' id="chk_<?php echo $r->c_group.$r->c_number;?>" />
                     
                        <label for="chk_<?php echo $r->c_group.$r->c_number; ?>">
                        ...
                        <label style="font-size: 11px"><?php echo $r->candidate_name; ?></label>
      ...
      <div class="card-body">
        <div class="row">
           <div class="col col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                 <input type="checkbox"  class="d-none no_candidate1 imgbgchk" name="no_candidate1" value="10" title='1' id="no_candidate1" />
                     
                        <label for="no_candidate1">
                          <img src="<?php echo base_url();?>uploads/pic/vote.jpg" alt="Image0" width="80px">
   ...
   <!-- <div style="border:3px; border-style:solid; border-color:#f1f5f9;padding-top: 15px;padding-bottom: 15px">
      <h6 class="card-text text-danger">
        ผู้สมัครที่เลือก  &nbsp;<span class="text-primary" id="vcount"></span>
      </h6>     

      <span class="text-success cnumber text-center" id="vdata"></span>
    </div> -->
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="row">
             ...
             <?php foreach ($candidate2s as $key => $r2){ ?>

              <div class="col col-lg-2 col-md-2 col-sm-2 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate2 imgbgchk" name="candidate_id2[]" value="<?php echo $r2->c_group.$r2->c_number; ?>" title='2' id="chk_<?php echo $r2->c_group.$r2->c_number;?>" />
                     
                        <label for="chk_<?php echo $r2->c_group.$r2->c_number; ?>">
                          <img src="<?php echo base_url();?>uploads/pic/number<?php echo $r2->c_number;?>.jpg" alt="Image<?php echo $r2->c_number; ?>" width="80px">                         
                          <div class="tick_container">
                            <div class="tick"><i class="fa fa-times" aria-hidden="true" ></i></div>
                          </div>
                        </label><br>
                         <label style="font-size: 11px"><?php echo $r2->candidate_name; ?></label>
    ...
    <div class="col-md-3">
     ...
     <div class="card card-danger">
      ...
      <div class="card-body">
        <div class="col col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                 <input type="checkbox"  class="d-none no_candidate2 imgbgchk" name="no_candidate2" value="10" title='2' id="no_candidate2" />
     ...
     $('#no_candidate1').attr('disabled', true);
      ...
      if(cnklen1 > 1 ){
        ...
        for (var checkbox1 of markedCheckbox1) {
          ...
          document.getElementById('vcount').innerHTML = cnklen1 ;
          document.getElementById('vdata').innerHTML += checkbox1.value + ' ';
     ...
     $('#no_candidate2').attr('disabled', true);
      ...
      /*  document.getElementById('vdata').innerHTML = "";
        for (var checkbox2 of markedCheckbox2) {
          ...
          document.getElementById('vcount').innerHTML = cnklen2 ;
          document.getElementById('vdata').innerHTML += checkbox2.value + ', ';
        
        //document.body.append(checkbox.value + ' ');
      }*/
      values1 = checkedElemets.map(function() {
    return {
      id: this.id,
      c_num: this.value,
      vgroup : this.title
        ...
        cancelButtonText: 'ยกเลิก',
          ...
          if (result.value) { //isConfirmed
            ...
            $(checkbox11).each(function(){
              checkbox_value.push($(this).val(),'1');
            });
            $(checkbox21).each(function(){
              checkbox_value.push($(this).val(),'2');
            });
            ...
            $.ajax({
              ...
              method:"POST",
              data:{checkbox_value:object3,otpcode:otpcode},
