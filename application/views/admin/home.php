      ...
      <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">จำนวนผู้มีสิทธิ</span>
                <span class="info-box-number"><?php echo $election_total;?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                   <h3 class="card-title">รายชื่อผู้สมัครประธานสหกรณ์ออมทรัพย์</h3>
                  ...
                  <tbody>
                     ...
                     ?>
                      ...
                      <td style="vertical-align:middle;text-align:center;"><?php echo $i;?></td>
                        ...
                        <td>
                          <img src="<?php echo base_url('uploads/pic/'.$r->picture);?>" width="80"  class=" my-n1" alt=""> <?php echo $r->candidate_name;?></td>
          ...
          <div class="col-md-6">
             <div class="card">
                <div class="card-header">
                   <h3 class="card-title">รายชื่อผู้สมัครคณะกรรมการบริหารสหกรณ์ออมทรัพย์</h3>
                  ...
                  <tbody>
                     ...
                     foreach ($candidate2s as $key => $r2){ 
                      ...
                      <td style="vertical-align:middle;text-align:center;"><?php echo $i;?></td>
                        ...
                        <td>
                          <img src="<?php echo base_url('uploads/pic/'.$r2->picture);?>" width="80"  class=" my-n1" alt=""> <?php echo $r2->candidate_name;?></td>
                       <td><?php echo $r2->department;?></td>
