                  ...
                  <tbody>
                     ...
                     foreach ($candidates as $key => $r){ ?>
                      ...
                      <td style="vertical-align:middle;text-align:center;"><?php echo $i;?></td>
                        ...
                        <td>
                          <img src="<?php echo base_url('uploads/2566/'.$r->picture);?>" class="img-fluid" width="100px">
                        ...
                        <td style="vertical-align:middle;text-align:center;">
                          ...
                          <a class="btn btn-info btn-sm btn-edit" href="#" data-id="<?= $r->id;?>" data-candidate_name="<?= $r->candidate_name;?>" data-department="<?= $r->department;?>" data-c_number="<?= $r->c_number;?>"  data-pid="<?= $r->pid;?>">
