...
@media print {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>พิมพ์ผลคะแนนเรียงตามหมายเลข</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">พิมพ์ผลคะแนนเรียงตามหมายเลข</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
             ...
             <!--     <div class="row">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-8 invoice-col">
                  <h4>แบบรายงานผลการออกเสียงเลือกตั้งคณะกรรมการดำเนินการสหกรณ์ออมทรัพย์</h4>
                  <h4>มหาวิทยาลัยสวนดุสิต จำกัด ประจำปี 2564</h4>
                  <h4>วันที่ 6 มีนาคมคม 2564 เวลา 09.00 - 10.30 น.</h4>
              ...
              <div class="row">
                <div class="col-12">
                 <h5> 1.จำนวนผู้มีสิทธิออกเสียงลงคะแนนเลือกตั้งคณะกรรมการดำเนินการสหกรณ์ออมทรัพย์ มหาวิทยาลัยสวนดุสิต จำกัด
  <?php echo $allvote;?> คน</h5>
              ...
              <br>
               <div class="row">
                <div class="col-12">
                 <h5> 2.ผลการออกเสียงลงคะแนนเลือกตั้งคณะกรรมการดำเนินการสหกรณ์ออมทรัพย์ มหาวิทยาลัยสวนดุสิต จำกัด (เรียงตามหมายเลข)</h5>
