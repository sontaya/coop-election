 <div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-lg-6">
                 ...
                 <a href="<?php echo site_url('admin/report/print1');?>" class="btn btn-primary">พิมพ์</a>
			        </div>
    ...
    <div class="row">
      <div class="col-md-12">
      <!--  <a href="<?php echo site_url('admin/report/print2');?>" class="btn btn-primary">พิมพ์ผลการเลือตั้ง</a>-->
      </div>
    </div>
    </section>
