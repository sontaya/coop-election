...
<head>
    ...
    <meta name="description" content="SDU COOP 2022">
    <meta name="author" content="paphawin panyasai">
    <meta name="generator" content="">
    <title>SDU COOP 2022</title>
...
<nav class="navbar navbar-expand-md navbar-custom bg-dark1 fixed-top">
    <a class="navbar-brand" href="<?php echo base_url();?>">
        <img src="<?php echo base_url();?>uploads/new_head20162.png" height="50px" alt="">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <?php if(!isset($this->session->userdata['logged_in'])){ ?>
            ...
            <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ข้อมูลผู้สมัคร</a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="<?php echo site_url();?>home/candidate1"">ผู้สมัครจากผู้แทนคณาจารย์ประจำ</a>
              <a class="dropdown-item" href="<?php echo site_url();?>home/candidate2"">ผู้สมัครจากผู้แทนสายสนับสนุน</a>             
            </div>
          </li>
         
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url();?>home/vote_check">ตรวจสอบผู้มีสิทธิเลือกตั้ง</a>
            </li>
            <?php }?>
