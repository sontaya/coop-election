            ...
            <div class="row">
             ...
             <?php foreach ($candidate1s as $key => $r){ ?>
              ...
              <div class="col col-lg-2 col-md-2 col-sm-2 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate1 imgbgchk" name="candidate_id1[]" value="<?php echo $r->c_number; ?>" title='1' id="chk_<?php echo $r->c_group.$r->c_number;?>" />
          ...
          <div class="card-body">
            <div class="row">
             ...
             <?php foreach ($candidate2s as $key => $r2){ ?>
              ...
              <div class="col col-lg-2 col-md-2 col-sm-2 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate2 imgbgchk" name="candidate_id2[]" value="<?php echo $r2->c_number; ?>" title='2' id="chk_<?php echo $r2->c_group.$r2->c_number;?>" />
...
<footer>
  <div class="container">
    <div class="row">        
      <div class="col-md-12 ">
        <div>  
          Copyright &copy; 2565 มหาวิทยาลัยสวนดุสิต
        </div>
      </div>
    </div>   
  </div>
        ...
        cancelButtonText: 'ยกเลิก',
          ...
          if (result.value) { //isConfirmed
            ...
            $.ajax({
              ...
              method:"POST",
              data:{checkbox_value:checkbox_value,otpcode:otpcode},
