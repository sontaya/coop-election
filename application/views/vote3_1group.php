 ...
 <nav class="navbar navbar-expand-md  bg-dark1 mb-4">
  ...
  <form action="" method="POST" id="frmvote">
      ...
      <div class="col-md-9">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">1.รายชื่อผู้สมัครคณะกรรมการดำเนินการ</h3> <span class="text-warning">(เลือกผู้สมัครได้ 7 คน) </span>
          </div>
          <div class="card-body">
            <div class="row">
             ...
             <?php foreach ($candidate2s as $key => $r2){ ?>
              ...
              <div class="col col-lg-3 col-md-3 col-sm-3 col-6 text-center">
                 <input type="checkbox"  class="d-none candidate2 imgbgchk" name="candidate_id2[]" value="<?php echo $r2->id; ?>" title='<?php echo $r2->c_number; ?>' id="chk_<?php echo $r2->id;?>" />
                     
                        <label for="chk_<?php echo $r2->id; ?>">
                          <img src="<?php echo base_url();?>uploads/2566/<?php echo $r2->picture;?>" alt="Image <?php echo $r2->c_number; ?>" width="100px">                         
    ...
    <div style="border:3px; border-style:solid; border-color:#f1f5f9;padding-top: 5px;padding-bottom: 5px">
      ...
      <span class="text-primary cnumber text-center" id="vdata2"></span>
    </div>

    <div class="p-2 text-center">
      <button type="button" class="btn btn-warning btn-circle btn-xxl shadow" id="submit2">ลงคะแนน</button>
     </div>
