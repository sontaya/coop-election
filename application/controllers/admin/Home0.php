...
class Home extends MY_Controller {
	...
	public function index()
    {
       ...
       /* $data2['applicant_total'] = $this->admin_model->get_applicant_total();
        $data2['election_total'] = $this->admin_model->get_election_total(); 
       
        $data2['allvote'] = $this->admin_model->allvote();*/
     ...
     public function account()
    {
        ...
        $data2['accs'] = $this->admin_model->get_user_acc();
        $data=array_merge($data1,$data2);
        $this->data = $data;
        $this->middle = 'admin/account';
        $this->admin();
    }
     public function setting()
    {
        ...
        $data2['settings'] = $this->admin_model->get_setting();
        $data=array_merge($data1,$data2);
        $this->data = $data;
        $this->middle = 'admin/setting';
        $this->admin();
    }
